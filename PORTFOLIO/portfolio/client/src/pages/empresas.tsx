  ...
  const companiesData = {
    'pt-br': [
      {
        ...
        locations: ["Brasil", "Salvador", "Rio de Janeiro", "São Paulo", "Recife", "Belo Horizonte +"],
      ...
      },
      {
        ...
        locations: ["Brasil","Salvador", "São Paulo", "Rio de Janeiro", "Brasília+"],
      ...
      },
      {
        ...
        segment: "Supermercado atacadista,pertencente ao grupo Carrefour",
        locations: ["Brasil"],
    ...
    'en': [
      {
        ...
        locations: ["Brazil", "Salvador", "Rio de Janeiro", "São Paulo", "Recife", "Belo Horizonte +"],
        clients: ["Petrobras", "Braskem", "Vale"],
        category: "logistica",
        color: "#1E40AF"
      },
      ...
      },
      {
        ...
        locations: ["Brazil" ," Salvador", "São Paulo", "Rio de Janeiro", "Brasília"],
      ...
      },
      {
        ...
        segment: "Wholesale supermarket, part of the Carrefour Group",
        locations: ["Brazil"],
    ...
    'es': [
      ...
      },
      {
        ...
        locations: ["Salvador", "Otros 60+ destinos en Brazil y extranjero"],
      ...
      },
      {
        ...
        segment: "Supermercado mayorista, parte del grupo Carrefour",
        locations: ["Brazil"],
